...
pub struct Preferences {
    ...
    /// Block expensive visual-only subresources like images, fonts, and media.
    pub network_block_visual_subresources_enabled: bool,
...
impl Preferences {
    const fn const_default() -> Self {
        Self {
            ...
            network_block_visual_subresources_enabled: false,
